dir_={ 
    'data':r'../news_classifcation/data',
    'output_dirs': r"/content/drive/MyDrive/news_data/",
    'ml_model_ckpt_dir':"/content/drive/MyDrive/news_data/ml_model",
}
